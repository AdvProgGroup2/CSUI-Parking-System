...
public class ParkingLot {
	...
	private int availableguest = 0; // added by hakeem
	List parkinglist;
	List idlist;
	...
	public void addParkingSpace(ParkingSpace space){
		if (!idlist.contains(space.getId())){
			...
			if(space.getAvailability() && space.getId()>20) availableguest += 1; // added by hakeem
		} else{
